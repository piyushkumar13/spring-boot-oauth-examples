...
public class SpringBootOauthAuthServerJpaWithPKCEForSecretClientApplication implements ApplicationRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(SpringBootOauthAuthServerJpaWithPKCEForSecretClientApplication.class, args);
    }
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        */
        ...
        CustomRegisteredClient customRegisteredClient = CustomRegisteredClient.builder()
            .id(id)
            .clientId("clientforpkcewithsecretclient")
            .clientName(id)
            .clientSecret(passwordEncoder.encode("myclientsecretforpkcewithsecretclient"))
            .authorizationGrantTypes(AuthorizationGrantType.AUTHORIZATION_CODE.getValue() + "," + AuthorizationGrantType.REFRESH_TOKEN.getValue())
            .redirectUris("http://127.0.0.1:8080/login/oauth2/code/my-client-oidc-for-pkce-with-secret-client")
//            .redirectUris("http://127.0.0.1:8080/authorized")
        ...
        if (customRegisteredClientRepository.findByClientId("clientforpkcewithsecretclient").isEmpty()) {
            log.info("Saving client as it is not already present, clientId=clientforpkcewithsecretclient");
        ...
        User user1 = User.builder()
            .firstName("Piyush")
            .lastName("Kumar")
            .emailId("pk@pkcesecretclient.com")
        ...
        User user1ByEmailId = userRepository.getUserByEmailId("pk@pkcesecretclient.com");
        if (Objects.isNull(user1ByEmailId) || Objects.isNull(user1ByEmailId.getEmailId())){
            log.info("Saving user1 as it is not already present, emailId=pk@pkcesecretclient.com");
        ...
        User user2 = User.builder()
            .firstName("Sandeep")
            .lastName("Kumar")
            .emailId("sandeep@pkcesecretclient.com")
        ...
        User user2ByEmailId = userRepository.getUserByEmailId("sandeep@pkcesecretclient.com");
        if (Objects.isNull(user2ByEmailId) || Objects.isNull(user2ByEmailId.getEmailId())){
            log.info("Saving user2 as it is not already present, emailId=sandeep@pkcesecretclient.com");
    ...
    private String writeMap(Map<String, Object> data) {
        ...
        ClassLoader classLoader = SpringBootOauthAuthServerJpaWithPKCEForSecretClientApplication.class.getClassLoader();
